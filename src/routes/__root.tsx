...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CampusLink — La plateforme universitaire nouvelle génération" },
      { name: "description", content: "CampusLink connecte étudiants et universités : notes, annonces, événements et gestion administrative en un seul endroit." },
      { name: "author", content: "CampusLink" },
      { property: "og:title", content: "CampusLink — Plateforme universitaire" },
      { property: "og:description", content: "Notes, annonces, événements. Toute la vie universitaire dans une seule app." },
