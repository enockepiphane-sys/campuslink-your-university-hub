...
function PlatformHome() {
  const [s, setS] = useState({ etabs:0, admins:0, etudiants:0, demandes:0 });
  useEffect(() => { (async () => {
    ...
    setS({ etabs:a.count??0, admins:b.count??0, etudiants:c.count??0, demandes:d.count??0 });
  })(); }, []);
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        {[
          ...
          { l:"Demandes en attente", v:s.demandes, i:"✉️" },
        ].map(k => (
